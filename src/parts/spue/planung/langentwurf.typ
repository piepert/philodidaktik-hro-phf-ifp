...
#orange-list-with-body[*Deckblatt*][
    ...
    *Informationen zur Schule*
    ...
    + *#ix("Akzentuierung")/#ix("Schwerpunktsetzung")/#ix("Reduktion", "Reduktion, didaktisch"):* Auch wenn "Reduktion" in der Philosophiedidaktik nicht gerne gesehen ist (denn das Ziel des Philosophieunterrichts ist das Philosophieren, das kann und darf man nicht "wegreduzieren"), müssen Sie den Inhalt der Stunde für die SuS zugänglich machen. Sie können inhaltlich nicht alles auf dem Niveau behandeln, wie Sie es in der #ix("Sachanalyse") dargestellt haben. Um etwa die Gottesbegriffe von #ix("Nietzsche", "Nietzsche, Friedrich") und #ix("Jonas", "Jonas, Hans") zu verstehen, ist der historische Hintergrund, in dem sich diese Positionen entwickelten, extrem relevant und daher in einer #ix("Sachanalyse") anzuführen, aber für den Unterricht kann es vernachlässigt werden, wenn es nur spezifisch um die Erkenntnis geht, dass es verschiedene Begriffsvorstellungen Gottes gibt. Hier können Sie durch Bezug auf die Ziele des Unterrichts und die #ix("Bedingungsanalyse") einen Schwerpunkt setzen, worauf sich der Inhalt der Stunde konzentrieren soll.
