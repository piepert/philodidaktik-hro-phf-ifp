...
Der #ix("Langentwurf") erklärt und begründet die Themenauswahl und Ihre Vorgehensweise soweit, dass ein anderer an Ihrer Stelle die Stunde vollständig nachvollziehen, halten und erklären könnte. Dazu werden die aktuellen Bedingungen und der Stand der SuS und der #ix("Lernumgebung") in der Bedingungsanalyse#ix([ ], "Bedingungsanalyse")aufgezeigt, die fachlichen Inhalte in der #ix("Sachanalyse") auf einem universitären Niveau dargestellt, in den #ix("didaktischen Überlegungen", "Überlegung, didaktisch") die Unterrichtstunde #ix("legitimiert", "Legitimation, didaktisch"), der inhaltliche Schwerpunkt gesetzt und der Lernweg strukturiert. Zuletzt wird in den #ix("methodischen Überlegungen", "Überlegung, methodisch") der konkrete Ablauf des Unterrichts in Bezug auf #ix("Sozialform"), #ix("Methoden", "Methode") und #ix("Medien", "Medium") erklärt und die Auswahl begründet, es findet jedoch kein Nacherzählen innerhalb des Langentwurfes statt! Jeder Schritt, bis auf die Sachanalyse und die #ix("Bedingungsanalyse") an sich, muss mit Bezug auf die #ix("Bedingungsanalyse") und die herausgestellte Zielgruppe betrachtet werden, da für diese der Unterricht erst entworfen werden soll. Diese und alle sonstigen Erklärungen zum Langentwurf richten sich nach den Handreichungen vom #ix("Landesweiten Zentrum für Lehrerbildung und Bildungsforschung Mecklenburg-Vorpommern", "ZLB") (ZLB) an der Universität Rostock.#en[Vgl. @ZLBHandreichung]
...
#orange-list-with-body[*Deckblatt*][
    ...
    *Informationen zur Schule*
    ...
    Die #ix("Bedingungsanalyse") stellt die Bedingungen, in und mit denen der Unterricht stattfinden soll, dar. Die #ix("Lerngruppe") und für die Planung relevante Charakteristika (psychologische und individuelle Besonderheiten, statistische Angaben) werden aufgelistet. Hier sollte eine entwicklungspsychologische Einordnung anhand des statistischen Altersdurchschnittes stattfinden. Dazu eignet sich etwa das Modell von #ix("Piaget", "Piaget, Jean").#en[Vgl. @SeitzSteinBerner2019_Entwicklung[S. 240 ff]] Dazu gehört auch die #ix("Umgebung", "Lernumgebung") dieser #ix("Lerngruppe") und die Eigenheiten der Örtlichkeit, an der die Unterrichtsstunde stattfinden soll. Sie können sich hier auf die Dinge beschränken, die für die Planung und Durchführung des Unterrichts tatsächlich relevant sind.
    ...
    + *Legitimation:* Ein Bezug auf den Rahmenplan kann hier eine grundlegende Legitimation des Themas und Ihrer Unterrichtsziele sein. Sie geben zusätzlich eine Begründung _mit Bezug auf die Bedingungsanalyse_ an, warum das Thema und die Unterrichtsziele für die SuS relevant waren, sind und sein werden. Dazu nehmen Sie Bezug auf #ix("Klafki", "Klafki, Wolfgang"):#en[Vgl. @Klafki1964_DidaktischeAnalyse[S. 15 ff] (Der ganze Text ist durchaus relevant! Lesen sie ihn!)]
        ...
        - *Zukunftsbedeutung:* Wie relevant wird das Thema für die SuS in der Zukunft sein? Ist absehbar, dass es ihnen in irgendeiner Form weiterhilft, für sie relevant sein wird oder in der Welt, in der sie aufwachsen, weiterhin von Bedeutung ist?
    ...
    + *#ix("Akzentuierung")/#ix("Schwerpunktsetzung")/#ix("Reduktion", "Reduktion, didaktisch"):* Auch wenn "Reduktion" in der Philosophiedidaktik nicht gerne gesehen ist (denn das Ziel des Philosophieunterrichts ist das Philosophieren, das kann und darf man nicht "wegreduzieren"), müssen Sie den Inhalt der Stunde für die SuS zugänglich machen. Sie können inhaltlich nicht alles auf dem Niveau behandeln, wie Sie es in der #ix("Sachanalyse") dargestellt haben. Bei der Reduktion unterscheidet man die Reduktion der Stoffülle (auch "Breitenreduktion") wie auch die Reduktion der inhaltlichen Komplexität (auch "Tiefenreduktion").#en[Vgl. @Lehner2020_DidaktischeReduktion[S. 73 ff., 120 ff]] Üblicherweise werden beide miteinander kombiniert.

        Um etwa die Gottesbegriffe von #ix("Nietzsche", "Nietzsche, Friedrich") und #ix("Jonas", "Jonas, Hans") zu verstehen, ist der historische Hintergrund, in dem sich diese Positionen entwickelten, extrem relevant und daher in einer #ix("Sachanalyse") anzuführen, aber für den Unterricht kann es vernachlässigt werden, wenn es nur spezifisch um die Erkenntnis geht, dass es verschiedene Begriffsvorstellungen Gottes gibt. Hier können Sie durch Bezug auf die Ziele des Unterrichts und die #ix("Bedingungsanalyse") einen Schwerpunkt setzen, worauf sich der Inhalt der Stunde konzentrieren soll.

    + *Strukturierung:* Erklären Sie, wie Sie Ihre Stunde strukturiert haben. Sollten Sie das PEST- oder Bonbon-Modell angewandt haben, benennen, erklären und begründen Sie das Modell und seine Nutzung konkret in Ihrer Situation. Nehmen Sie Bezug auf die Primärliteratur des jeweiligen Modelles.#en[Die Quellenangaben sind in dem jeweiligen Abschnitt zum Modell angegeben.] Erklären Sie, wie Sie das Thema _inhaltlich_ aufbauen. Hier nennen Sie _keine_ #ix("Methoden", "Methode") oder #ix("Sozialformen", "Sozialform"), die sind erst in den "Methodischen Überlegungen" relevant. Geben Sie aber Verkürzungsmöglichkeiten und eine begründete didaktische Reserve an.
    ...
    Im Literaturverzeichnis bzw. der Bibliographie listen Sie die verwendete Literatur einheitlich nach einem einheitlichen Zitierstil alphabetisch sortiert auf. Literaturverwaltungsprogramme wie Citavi oder Zotero inkl. Plugins für Word, LibreOffice o.ä. sind hilfreich. Wer technisch sehr versiert ist oder bereits Erfahrung im Bereich von den folgenden derartigen Textsatzprogrammen hat, kann das ältere LaTeX oder auch das jüngere Typst die Literaturverwaltung übernehmen lassen.
]