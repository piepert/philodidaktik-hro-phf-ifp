...
+ *Schülerverhalten (erwartet):* #ix("Erwartungshorizont") der Aufgaben, konkrete Handlungen oder möglicherweise aufkommende konkrete Fragen
...
+ *Erarbeitungsphase:* Nachdem das Problem herausgestellt wurde, wird es durch die SuS inhaltlich bearbeitet und Kompetenzen werden verbessert.
