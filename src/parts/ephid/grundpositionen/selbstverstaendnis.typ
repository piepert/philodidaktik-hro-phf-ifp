...
#orange-list[
    #ix(strong[esoterisches Selbstverständnis], "Selbstverständnis, esoterisch") #h(1fr) #ix("Heraklit"), #ix("Nietzsche", "Nietzsche, Friedrich W.")
