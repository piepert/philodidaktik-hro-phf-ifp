...
#table(columns: (20%, auto, auto, auto),
    ...
    [
        ...
        Führen Sie eine philosophische Problemreflexion zu #ix("Descartes", "Descartes, René") #ix("methodischem Zweifel", "Zweifel, methodisch") durch!
    ...
    [
        ...
        Erörtern Sie, ob und inwiefern #ix("Descartes", "Descartes, René") #ix("Zweifel", "Zweifel, methodisch") an der Existenz des #ix("Fremdpsychischen", "Fremdpsychisches") eine Bedeutung für die alltägliche Lebensgestaltung hat!
    ],
