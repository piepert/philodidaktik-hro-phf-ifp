#import "/src/kurzentwuerfe/template.typ": *
...
#schedule(class: 9,
    ...
    *Motivationsphase*\ /10 min, 9:00 Uhr
    ...
    Tafel, Stift, \
    #smallcaps[Warner Bros. Entertainment]: _Matrix Trailer_. https://www.youtube.com/watch?v=ETvkaFGs6d4. (Letzter Zugriff #the-date.)
][
